...
\begin{itemize}
    \item \bf{function/map} from A to B : each element of A exactly $f$-related to one element of B.
        \begin{itemize}
            ...
            \item every element in A $f$-related to at least one of B
            $ \forall x \in A \: \exists y \in B \:\: (x,y) \in f$
            \item every element in A $f$-related to at most one of B
...
\begin{itemize}
    ...
    \begin{itemize}
        \item $\forall x_1, x_2\in A \ (f(x_1) = f(x_2) \Rightarrow x_1 = x_2)$
        \item injective test: $\forall X \subseteq A, X \subseteq f^{-1}(f(X))$
    \end{itemize}
    \item \bf{bijective} : both surjective \& injective
    \begin{itemize}
        \item if $f$ is a bijection $A \then B$ , then $f^{-1}$ is a bijection $B \then A$ (P7.4.3)
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    \end{itemize}
\end{itemize}
\subsection{same cardinality} % to do
\begin{center}
\end{center}

\section{9. COUNTABILITY} % to do
